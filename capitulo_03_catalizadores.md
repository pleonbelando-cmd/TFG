...
Con datos mensuales, esta condición es más fácilmente satisfecha que con datos diarios: las variables macroeconómicas (IPC, TIPS, reservas de bancos centrales) son publicadas con retardo por las agencias estadísticas, de modo que en el momento en que se observan ya son información del pasado. La variable de reservas de bancos centrales, que entra retardada dos meses, satisface esta condición por construcción. Para los activos financieros cotizados en tiempo real (DXY, VIX, S&P 500), la endogeneidad potencial —el precio del oro podría afectar al VIX simultáneamente— se tratará con la especificación VAR del Capítulo 5, que modela todas las variables como endógenas simultáneamente, eliminando el problema de raíz.
